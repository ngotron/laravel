...
<body>
    <form class="container" method="post" action="{{route('phepTinh')}}">
        @csrf
        <h2>Cộng hai số </h2>
        <div class=" mb-3">
        ...
        <div class="mb-3" id="c">
            <input type="radio" id="age1" name="c" value="cc" selected>
            <label for="age1">Cộng</label><br>
            <input type="radio" id="age2" name="c" value="tr">
            <label for="age2">TRừ</label><br>
            <input type="radio" id="age3" name="c" value="nh">
            <label for="age3">Nhân</label><br>
            <input type="radio" id="age3" name="c" value="ch">
